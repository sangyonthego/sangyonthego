const travelData = {
  ...
  coorg: {
    ...
    image: "../assets/media/coorg/coorg.jpg",
  ...
  mumbai: {
    ...
    image: "../assets/media/mumbai/mumbai.jpg",
...
function renderPlaceContent(placeKey) {
  ...
  heroImage.src = place.image;
  heroImage.alt = `${place.title} hero`;
  ...
  if (place.highlights) {
    highlights.innerHTML = `<iframe width="100%" height="400px" src="${place.highlights}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`;
  ...
  currentGallery.forEach((src, index) => {
    ...
    img.src = src;
    img.alt = `${place.title} photo ${index + 1}`;
